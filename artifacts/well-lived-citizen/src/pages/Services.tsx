...
export default function Services() {
  useEffect(() => {
    document.title = "Services & Pricing — The Well Lived Citizen Co";
  }, []);
    ...
    <div className="page">
      ...
      <section style={{ padding: "48px 0 72px", borderTop: "1px solid var(--linen)" }}>
        <div className="container" style={{ maxWidth: "760px", textAlign: "center" }}>
          <p style={{ fontSize: "16px", color: "var(--stone)", marginBottom: "24px" }}>
            Not sure where to start? Start with what is most real right now.
          </p>
          <p style={{ fontSize: "14px", color: "var(--clay)", lineHeight: 1.75, marginBottom: "32px", maxWidth: "520px", marginLeft: "auto", marginRight: "auto" }}>
