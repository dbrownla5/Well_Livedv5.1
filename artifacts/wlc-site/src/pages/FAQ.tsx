...
const faqSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do you work with people in difficult or private situations?", a: "Yes. I absolutely work with people navigating difficult and private situations — leaving a hard place, managing a move someone else can't face, or simply needing a trusted person to handle something you can't do yourself. I handle these on a case-by-case basis, always with safety and discretion for everyone involved. No one who reaches out is left without support." },
    ]
  },
];
