        ...
        <div className="container">
          ...
          <div style={{ maxWidth: 720 }}>
            {[
              ...
              { q: "Can I book this for someone else?", a: "Yes. Many clients book for a parent, sibling, or friend going through a big change. I also work with people navigating difficult situations — leaving a hard place, managing a move someone else can't face. These are handled with safety and discretion. No one who reaches out is left without support." },
            ].map((item, i) => (
