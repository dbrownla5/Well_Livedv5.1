        ...
        <div className="container">
          ...
          <div style={{ maxWidth: 720 }}>
            {[
              ...
              { q: "Is this only for estates?", a: "No. Many clients do this proactively — before there's any pressure to. It's actually easier and more thorough when there's no urgency. The best time to do this work is before you need it." },
            ].map((item, i) => (
